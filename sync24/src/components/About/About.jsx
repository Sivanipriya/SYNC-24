      ...
      <div className="about-content">
        ...
        <div className="about-text">
          <p>
            ...
            Well-being. Sync ‘23 is about to blossom afresh on 17th and 18th of
            October, 2023. Encompassing multifarious events, this version has
            ...
            vision and thus with the past experiences, Sync ‘23 is all set to
      ...
      <div className="about-extra">
        ...
        <div className="extra-items">
          ...
          <div className="extra-item">
            ...
            <p className="bold">
              An award recognizing your talent is an honour
            </p>
